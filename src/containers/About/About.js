    ...
    <AboutStyled>
      ...
      <AboutBlock>
        ...
        <AboutBio>
          ...
          So we wanted to empower you with jewelry inspired by the way you dynamically respond to all the changes in your life.
          With LIMNIA , we’ve built a clever, customizable jewelry line that morphs with you. A necklace becomes a pair of anklets; an earring turns into a ring. 
          Crafted from the finest materials and precious stones (think 14k gold, white or black diamonds), 
          LIMNIA'S contemporary fine jewelry can be modified to match your mood, no matter where you are.
        </AboutBio>
      </AboutBlock>
    </AboutStyled>
  );
